...
const technologies: Technologies = {
  'Languages & Frameworks': [
    { text: 'JavaScript', logo: 'lucide:terminal' },
    { text: 'PHP', logo: 'lucide:terminal' },
    { text: 'Go', logo: 'lucide:terminal' },
    { text: 'C', logo: 'lucide:terminal' },
    { text: 'HTML', logo: 'lucide:terminal' },
    { text: 'CSS', logo: 'lucide:terminal' },
    { text: 'Vue', logo: 'lucide:terminal' },
    { text: 'React', logo: 'lucide:terminal' },
    { text: 'Svelte', logo: 'lucide:terminal' },
  ],
  ...
  'Cloud & Infrastructure': [
    { text: 'Google Cloud', logo: 'simple-icons:cloud' },
    { text: 'AWS', logo: 'lucide:cloud' },
    { text: 'Linode', logo: 'lucide:server' },
    { text: 'Oracle Cloud', logo: 'simple-icons:cloud' },
    { text: 'Cloudflare', logo: 'simple-icons:cloud' },
