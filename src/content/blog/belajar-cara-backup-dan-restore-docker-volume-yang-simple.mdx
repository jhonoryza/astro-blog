...
description: 'Kali ini kita akan mempelajari cara membackup dan merestore docker volume, hal ini akan sangat berguna ketika kita memiliki data2 yang sangat penting dan diperlukan backup.'
date: '08-05-2023 16:00:00'
tags: ["volume", "docker", 'backup', 'restore']
draft: false
---
...
buat file backup.env isi dengan seperti ini:
...
pada step ini kita akan membuat docker volume baru bernama new_vaultwarden_vol dan new_mariadb_vol dan container sementara bernama temp1 dan temp2
...
docker volume new_vaultwarden_vol dan new_mariadb_vol sudah siap untuk digunakan