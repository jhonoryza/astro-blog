---
title: 'Microservice Frontend Integration'
description: 'Frontend does not know anything about these different services and ports. We need a gateway between the FE and the services'
date: '08-05-2024 21:57:00'
tags: ["microservice", "frontend", "integration"]
draft: false
---
...
The answer is that our frontend does not know anything about these different services and ports. 
