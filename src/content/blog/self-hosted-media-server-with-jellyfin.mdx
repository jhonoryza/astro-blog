---
title: 'Self Hosted Media Server with Jellyfin'
description: 'This guide will walk you setting up a self-hosted media server using Jellyfin and Docker'
date: '12-31-2024 22:00:00'
tags: ["jellyfin", "media server"]
draft: false
---
...
You can force the setup wizard to show up by going to the following link:
