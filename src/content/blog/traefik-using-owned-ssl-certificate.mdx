---
title: 'Traefik using owned SSL certificate'
description: 'Example docker-compose.yml Configuration for Traefik with SSL'
date: '09-12-2024 17:49:00'
tags: ["traefik", "ssl", "docker", "compose"]
draft: false
---
